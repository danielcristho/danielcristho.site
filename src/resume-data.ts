export const RESUME_DATA = {
  ...
  about:
    "A student with a focus on networking, programming system administration & DevOps. With 3 years experience as Sysadmin & IT Infra.",
  summary: "",
  ...
  work: [
    ...
    },
    {
      ...
      usedTechnologies: ["Mikrotik", "Cisco", "Unifi (Ubiqiti)"],
    },
  ],
  skills: [
    "DevOps",
  ...
  organizational_volunteering: [
    {
      company:
        "Networking Technology and Intelligent Cybersecurity Laboratory ITS",
