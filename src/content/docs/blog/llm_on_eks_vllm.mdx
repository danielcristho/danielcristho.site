...
date: 2026-04-27
description: Serve LLM on EKS using vLLM
...
Before getting into the code, let's set up a `.env` file at the root of the project. We'll use this to manage our HuggingFace token and AWS configurations so we don't hardcode them into the repository.
