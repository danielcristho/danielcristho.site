---
title: Install Docker using Ansible
date: 2023-08-28
description: Create ansible playbook to install docker on remote server.
excerpt: Let’s create Ansible Playbook to install Docker on remote server.
tags:
  - Ansible
  - Docker
authors:
...
On tasks directory create new file called `main.yml`. This file contains _Docker installation, Docker Compose installation & private registry setup_.
