---
title: Running Firefox in Docker? Yes, with a GUI and noVNC
date: 2025-11-21
description: Running Firefox inside Docker container with a GUI and noVNC.
excerpt: Docker isn’t just for serve your code, appliactions. you can actually run a full desktop app inside it. In this project, I containerized Firefox with a virtual desktop and made it accessible through a browser using noVNC.
tags:
  - Docker
  - Linux
authors:
...
cover:
  alt: Cover image
  image: https://res.cloudinary.com/diunivf9n/image/upload/v1774263488/firefox-docker_sr03q7.webp
---
...
:::note
😎 This post is part of my **“Container Stuffs”** open-source project on GitHub. Upcoming labs include:
...
![Container Stuff](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/n5g8udk80m4xd47d679g.png)
