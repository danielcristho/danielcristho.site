---
title: "K3D: Monitoring Your Service using Kubernetes Dashboard or Octant"
date: 2025-01-03
excerpt: In this blog, I will explore two popular monitoring tools for Kubernetes.
description: Monitoring Kubernetes services using Kubernetes Dashboard or Octant.
tags:
  - Kubernetes
  - Docker
authors:
...
cover:
  alt: Cover image
  image: https://res.cloudinary.com/diunivf9n/image/upload/v1774263952/k3d-k8s-octant_v4pnwp.webp
---
...
![Login to Kubernetes Dashboard](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/hlgts2cocnoi1j24bv7s.png)

![See the services](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/ro6mxv84hr4d8s0tqdzr.png)
