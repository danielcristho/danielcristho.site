...
date: 2025-03-20
excerpt: Hi! In this post, I'll show you how to deploy a Go API using Supervisor to manage the process and Nginx as a web server to serve it.
...
![Go, Supervisor & Nginx Cover](https://res.cloudinary.com/diunivf9n/image/upload/v1744701309/go-supervisor-nginx-cover_very7d.png)
