---
title: "Docker Image Compression: gzip vs zstd"
date: 2025-12-02
description: Compare gzip and zstd to compress Docker image.
excerpt: Docker images are already compressed when you push them to registries like Docker Hub, GHCR, AWS ECR, etc. So why would anyone compress an image again by using gzip or zstd?
tags:
    - Docker
    - Linux
authors:
  - danielcristho
cover:
  alt: "Docker image compression cover"
  image: "https://res.cloudinary.com/diunivf9n/image/upload/v1744701420/docker-cover.png"
---
...
**-** [alpine](https://hub.docker.com/layers/library/alpine/latest/images/sha256-9eec16c5eada75150a82666ba0ad6df76b164a6f8582ba5cb964c0813fa56625)-> ~8MB
...
$ time scp mariadb_10.tar.gz onomi@myserver:/tmp/
...
> `gzip`is faster than `zstd` at compression.
