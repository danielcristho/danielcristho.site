---
title: Deploying a Simple Flask API Using Gunicorn, Supervisor & Nginx
date: 2025-04-30
excerpt: Hi there! Flask is great for building APIs quickly. But turning your local project into a publicly accessible web service involves a few extra steps that aren’t always obvious.
description: Deploy a Flask API with Gunicorn, Supervisor and serve it through Nginx.
tags:
  - Python
  - Linux
authors:
...
cover:
  alt: Cover image
  image: https://res.cloudinary.com/diunivf9n/image/upload/v1774263623/supervisor-nginx-py_jirxkd.webp
---
...
![Deployment Flow](https://res.cloudinary.com/diunivf9n/image/upload/v1746028839/flask-api-flow_ouvbts.png)
