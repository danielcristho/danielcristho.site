---
title: "Kubernetes 104: Controllers"
date: 2025-01-22
excerpt: Now I’m going to talk about Controllers in Kubernetes. In Kubernetes, a Controller is like a cluster’s brain, constantly working to ensure the system maintains its desired state.
description: Controllers in kubernetes.
tags:
    - Kubernetes
    - Read From Book
authors:
