---
title: "AWS EKS: Create Your First Cluster Using AWS CDK"
date: 2026-01-28
description: Create EKS (Kubernetes service in AWS) using AWS CDK
excerpt: About 2 years ago, I’ve been using AWS CDK to manage infrastructure, mostly for smaller workloads like deploying APIs on AWS Lambda. This year, I want to take it a step further by using AWS CDK to create and manage an AWS EKS cluster.
tags:
  - AWS
  - Kubernetes
  - Python
  - Series
cover:
  alt: AWS EKS with CDK cover image
...
[danielcristho/that-i-write/create-kube-cluster](https://github.com/danielcristho/that-i-write/tree/main/eks-cdk/create-kube-cluster)
