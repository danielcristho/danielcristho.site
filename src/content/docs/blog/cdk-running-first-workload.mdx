...
excerpt: Deploy your first workload on Amazon EKS using AWS CDK—defining Kubernetes resources in code, exposing services, and understanding how updates are applied in practice.
tags:
  - AWS
  - Kubernetes
  - Python
