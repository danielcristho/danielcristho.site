---
title: "AWS EKS: Running Your First Workload Using AWS CDK"
date: 2026-02-06
description: Running workloads in EKS (Kubernetes service in AWS) using AWS CDK
excerpt: Deploy your first workload on EKS using AWS CDK—defining Kubernetes resources in Python code, exposing services, and understanding how updates are applied in practice.
tags:
  - AWS
  - Kubernetes
  - Python
...
cover:
  alt: Cover image
  image: https://res.cloudinary.com/diunivf9n/image/upload/v1774262350/k8s-cdk-cover_e2tyhv.webp
---
...
BTW, our project structure should be like this one:
...
```py title="running_first_workloads_stack.py"
...
Before we dive deeper, here is the full code for `eks_stack.py`

```py title="eks_stack.py"
from aws_cdk import (
Stack,
aws_eks as eks,
aws_ec2 as ec2,
...
Aight, thanks for taking the time read this post, don't forget to cleanup the stack. Here is the full code of this post:
