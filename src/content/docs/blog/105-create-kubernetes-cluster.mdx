---
title: "Kubernetes 105: Create Kubernetes Cluster"
date: 2025-02-01
excerpt: In this part of the Kubernetes series, we will explore how to create a Kubernetes cluster in different environments. Whether you’re running Kubernetes locally or in the cloud, understanding how to set up a cluster is fundamental to deploying and managing containerized applications efficiently.
description: Create Kubernetes cluster in several ways.
tags:
    - Kubernetes
    - AWS
    - Read From Book
...
![Kind Logo](https://res.cloudinary.com/diunivf9n/image/upload/v1744701500/kind-logo_ogwjl1.png)
...
![K3D Logo](https://res.cloudinary.com/diunivf9n/image/upload/v1744701724/k3d-logo_rpdlwz.png)
...
![AWS EKS Logo](https://res.cloudinary.com/diunivf9n/image/upload/v1744701499/eks-logo_dmpopg.png)
